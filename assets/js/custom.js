! function(e) {
	"use strict";
	async function t(t) {
		await dsnGrid.destoryBuild(), await a("poster"), await a("src"), await a("srcset"), t || (window.$effectScroll = await
			function() {
				const t = window.Scrollbar;
				var n = document.querySelector("#dsn-scrollbar");
				return {
					start: function() {
						$body.removeClass("locked-scroll"), e(".box-view-item .box-img .dsn-scroll-box").each((function() {
							t.init(this, {
								damping: .06
							})
				...
				return {
					allInt: function() {
						this.clearControl().then(() => {
							...
							$effectScroll.scrollNavigate(), $effectScroll.getListener((function(e) {
					...
					nextProject: function() {
						...
						const o = dsnGrid.tweenMaxParallax($controller).addParrlax({
							...
							tween: gsap.timeline({
								...
								y: 0,
								scale: 1.2
							}, 0).fromTo(t.find(".project-number , .metas"), {
								y: -100,
								yoyo: !0,
								overwrite: "none"
							}, {
						...
						o.on("progress", (function(e) {
							i.css({
								filter: "blur(" + 10 * e.progress + "px)"
							})
						})), a.length && s.to(a.find("span.d-none"), {
							yoyo: !0,
							overwrite: "none",
							width: "100%"
						}, 0);
						...
						l.on("progress", (function(e) {
							t.find(".case .number").text((100 * e.progress).toFixed(0) + "%"), i.css({
								filter: "blur(" + (10 - 10 * e.progress) + "px)"
							}), e.progress > .998 && t.find("a").click()
						})), l && $scene.push(l)
					},
					...
					dsnScrollTop: function() {
						...
						const n = dsnGrid.tweenMaxParallax($controller).addParrlax({
							id: t,
							triggerHook: t.offset().top > 50 ? .5 : 0,
							offset: t.offset().top > 50 ? 0 : 100,
							duration: t.height() - .5 * $wind.height() + (e(".next-project").outerHeight() || 0) - (t.offset().top > 50 ? 0 : 300),
							tween: gsap.to(".scroll-to-top > img", .3, {
								rotation: t.height() / 2
							})
						});
					...
					translateSection: function() {
						e(".section-image.section-move-image .transform-move-section").each((function() {
							...
							e(this).find(".swiper-slide").each((function() {
								n += e(this).outerWidth()
							})), e(this).append(e(this).find(".swiper-slide").clone()), e(this).append(e(this).find(".swiper-slide").clone()), n -= e(this).width(), e(this).hasClass("move-left") ? t.to(this, {
								x: -1 * n
							}) : t.from(this, {
								x: -1 * n
							});
				...
				return {
					...
					hamburgerOpen: function() {
						...
						a.set(n.find(".icon-center"), {
							...
							autoAlpha: 1
						}, "-=1"), a.reverse(), i.find("ul.extend-container > li.dsn-drop-down").on("click", (function(t) {
							t.stopPropagation(), s._tDur > 0 || ((s = gsap.timeline({
								...
								display: "flex"
							}), s.to(i.find("ul.extend-container > li > a ").find(".dsn-title-menu , .dsn-meta-menu"), .5, {
								y: -30,
								autoAlpha: 0,
			...
			}().init(), await dsnGrid.removeWhiteSpace(".site-header ul.extend-container li > a"), await
			function() {
			...
			}()), t && await o(t), e("a.vid").YouTubePopUp(), await
		function(t) {
		...
		}(), await $effectScroll.start(), await
		function() {
			$wind.off("scroll");
			const t = e(".wrapper");
			let n = 0;
			...
			return {
				run: async function() {
					...
					t.each((function() {
						...
						}) : o.find(".slide-item").length && i.initSlider(a).then((function(e) {
							let t = i.swiperObject(a, !s);
							i.slideChange(t, a, s ? "x" : "y"), dsnGrid.addSwiper(t), console.log(t.getTranslate()), a.find(".next-container").on("click", (function() {
						...
						on: {
							init: function() {
								...
								t.find('[data-dsn="video"] video').each((function() {
									...
									e(this).attr({
										"data-swiper-parallax": t / 100 * (n ? i.height : i.width)
									})
								}))
							},
							touchStart: function() {
				...
				slideChange: function(t, i, a) {
					...
					t.on("slideChange", (async function() {
						...
						})), n.staggerFromTo(p ? u.toArray().reverse() : u, .8, s.hideText(!p, a).title, s.showText(a).title, .05, "-=.1"), o = l = r = d = c = f = u = p = null
					}))
				},
				slideChangeWeb: function(e, t, i, a, s) {
					...
					e.find(".slide-inner").attr("data-overlay", l.data("overlay")), n.progress(1), n = new gsap.timeline, n.staggerFromTo(s ? o.toArray().reverse() : o, .3, this.showText(t).title, this.hideText(s, t).title, .05, 0, (function() {
					...
					})), n.staggerFromTo(s ? r.toArray().reverse() : r, .8, this.hideText(!s, t).title, this.showText(t).title, .05, "-=.1")
				},
				showText: function(e) {
					let t = {
						title: {
		...
		function() {
			...
			t.empty(), e("[data-dsn-title]").each((function() {
				...
				a.html(n), t.append(a), a.on("click", (function() {
		...
		function() {
			...
			if (t < 1) return;
			t.validator(), t.off("submit"), t.on("submit", (function(n) {
		...
		}(), await n().ajaxLoad(), await (e('a[href="#"]').on("click", (function(e) {
			e.preventDefault()
		...
		})), void(window.location.hash.length && ($wind.scrollTop(0), dsnGrid.scrollTop(window.location.hash, 1, -100)))), await e(".twentytwenty").twentytwenty()
	}
		...
		return {
			...
			ajaxSlider: function(t) {
				let n = t.parents(".slide-content"),
					i = n.data("dsn-id"),
					a = n.parents(".main-slider").find('.slide-item[data-dsn-id="' + i + '"] .cover-bg').first(),
					s = n.find(".title"),
					o = n.parents(".main-slider").find(".bg-container");
				a.removeClass("hidden"), n.data("webgel-src") && (a = e("<div class='cover-bg'></div>").attr({
			...
			ajaxNextProject: function(e) {
				...
				a.to(s || $wind, 1, {
					scrollTo: {
						y: s ? $effectScroll.getScrollbar().limit.y : document.body.scrollHeight
					}
				}), a.call(this.dsnCreateElement.bind(this, n, t, i.find(".title"), i, {
					before: function(e, t, n) {
						n.removeClass("border-top").removeClass("border-bottom")
					}
				})), a.call((function() {
					$effectScroll.locked(), a.call((function() {
						dsnGrid.scrollTop(0, .01)
					}))
				})), t = n = i = null
			},
			...
			dsnCreateElement: function(t, s, o, l, r = {}) {
				...
				n = this.addElement(d, t, s), (i = this.addElement(d, o, l)).find(".dsn-chars-wrapper").length || dsnGrid.convertTextLine(i), void 0 !== r.before && r.before(d, n, i), $body.append(d), a.to(d, 1, {
					autoAlpha: 1,
					ease: Power4.easeInOut
				}, "-=0.8"), void 0 !== r.after && r.after(d, n, i)
			},
			completeElement: function(t) {
				...
				if (i.length) {
					o = o.first(), o.find(".dsn-chars-wrapper").length || dsnGrid.convertTextLine(o), l = o.offset(), void 0 === l && (l = {
						top: 0,
						left: 0
					}), a.set(i.find(".dsn-chars-wrapper"), {
						x: i.offset().left - l.left,
						y: i.offset().top - l.top
					}, "-=1");
					let e = i.find(".dsn-chars-wrapper").toArray();
					i.offset().left < l.left && e.reverse(), a.set(i, {
						top: l.top,
						left: l.left
					}, "-=0.8"), a.to(i, .4, {
						padding: "0",
						...
						yoyo: !0
					}, "-=0.8"), i.css("width", o.outerWidth()), a.set(e, {
						color: i.css("color")
					}), a.staggerTo(e, .8, {
						y: "0",
						x: "0",
